<template>
  <div id="root">
    <div class="wr-transactions-intro">
      <div class="container">
        <div class="page-navigation">
          ...
          <ul>
            <li>
              <a v-show="!!website" :href="website" target="_blank" rel="nofollow">{{ $t('project.ABOUT_PROJECT') }}</a>
            </li>
          </ul>
        </div>
    ...
    <div class="wr-filter" v-show="true">
      <div class="container">
        <div class="filter">
          <h2>{{ $t('project.PROJECT_REPORT') }}</h2>
          <ul>
            <li>
              <select v-show="false">
  ...
  export default {
    ...
    methods: {
      fetch () {
        ...
        return foundationApi.find.project.one(this.idFoundation, this.idProject, filter)
          .then((data) => {
            this.name           = data.project.name
            this.website        = data.project.website
            this.foundationName = data.project.nameFoundation
